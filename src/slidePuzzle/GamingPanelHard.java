...
public class GamingPanelHard extends JPanel {	
	...
	public GamingPanelHard(ViewChange window) {
		setPreferredSize(new Dimension(900,600));
		setBackground(Color.pink);
		setLayout(null);
		
		
		sort = new SortImage(36);
		sort.Sorting(6);
		...
		btnMenuArray = new JButton[36];
		for (int i=0; i<36; i++) {
			btnMenuArray[i] = new JButton(new ImageIcon("hardImage/hard"+sort.Getarray(i) +".png"));
